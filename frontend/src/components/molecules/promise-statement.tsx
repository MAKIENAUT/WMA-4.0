export default function PromiseStatement() {
  return (
    <div className="from-wma-darkTeal to-wma-teal relative z-10 rounded-xl bg-gradient-to-r p-6 shadow-[4px_4px_4px_0_rgba(0,0,0,0.25)] sm:w-2/3 md:w-1/2 md:p-8 xl:p-12">
